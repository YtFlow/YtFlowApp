                 ...
                 {{"desc", "UWP VPN Plugin TUN interface."},
                  ...
                  {"param",
                   {{"dns", nlohmann::json::array({"11.16.1.1", "260c:1::1"})},
                    ...
                    {"ipv6", "fd00::2"},
                    {"ipv6_route", nlohmann::json::array({"::/16", "260c:2001::/96", "260c:1::/96",
                                                          "2001:0b28:f23c::/46", "2001:067c:04e8::/48"})},
                    {"web_proxy", nullptr}}}}},
                {"proxy-forward",
                 {{"desc", "Forward connections to the proxy outbound."},
                  {"plugin", "forward"},
                  {"plugin_version", 0},
                  {"param", {{"request_timeout", 200}, {"tcp_next", "outbound.tcp"}, {"udp_next", "phy.udp"}}}}},
                {
                    "direct-forward",
                    {{"desc", "Forward connections to the physical outbound."},
                     {"plugin", "forward"},
                     {"plugin_version", 0},
                     {"param", {{"request_timeout", 200}, {"tcp_next", "phy.tcp"}, {"udp_next", "phy.udp"}}}},
                },
                {
                    "outbound",
                    ...
                    {{"desc", "Dispatches DNS requests to our DNS server."},
                     ...
                     {"param",
                      {{"fallback_tcp", "reject.tcp"},
                       ...
                       {"rules",
                        {{{"src",
                           {{"ip_ranges", {"0.0.0.0/0", "::/0"}}, {"port_ranges", {{{"start", 0}, {"end", 65535}}}}}},
                          {"dst",
